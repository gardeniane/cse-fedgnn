...
def main():
    ...
    RL_path = './results/rl/cluster_wise_CS_RL_{}_{}client1.npz'.format(fl_config.dataset_name, fl_config.clients.total)
    reward_path ='./results/rl/cluster_wise_CS_RL_reward_{}_{}client1.npz'.format(fl_config.dataset_name, fl_config.clients.total)
    actor_path = './results/rl/cluster_wise_CS_actor_model_{}_{}client1'.format(fl_config.dataset_name, fl_config.clients.total)
    ...
    dataset_name = fl_config.dataset_name + "_partial"
